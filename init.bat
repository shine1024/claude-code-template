...
$RequiredEntries = @("CLAUDE.local.md", ".claude/settings.local.json", ".claude/hooks/.task_start", ".claude/viewer/response-*.md", ".claude/viewer/.waiting-*", ".claude/viewer/sessions.json", ".claude/viewer/sessions.json.tmp", ".claude/cache/")
